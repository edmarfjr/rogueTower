...
class EnemyFactory {
  ...
  static EnemyBoss createAgiota(Vector2 pos, {int phase = 1}) {
    return EnemyBoss(
      bossName: "agiota".tr(),
      hp: hpBossMedio * phase, // (0.5 + (phase*0.5)),
      position: pos,
      speed: 50,
      soul: 250, 
  ...
  static Enemy createRat(Vector2 pos,{bool noChamp = false, int champType = 0, int phase = 1}) {
    return Enemy(
      ...
      noChamp: noChamp,
      championType: champType,
      hp: hpMedio * phase, // (0.5 + (phase*0.5)),
      speed: 50,
      hbSize: Vector2(12,9),
  ...
  static Enemy createWorm(Vector2 pos,{bool noChamp = false, int champType = 0, int phase = 1}) {
    return Enemy(
      ...
      championType: champType,
      animSemMove: true,
      hp: hpFraco * phase, // (0.5 + (phase*0.5)),
      speed: 50,
      weight: 5,
  ...
  static Enemy createBee(Vector2 pos,{bool noChamp = false, int champType = 0, int phase = 1}) {
    return Enemy(
      position: pos,
      noChamp: true,
      hp: hpMinimo * phase, // (0.5 + (phase*0.5)),
      speed: 50,
      isMinion: true,
      voa: true,
      rotates: true,
  ...
  static EnemyBoss createRatKing(Vector2 pos, {int phase = 1}) {
    return EnemyBoss(
      bossName: "reiRato".tr(),
      hp: hpBossFraco * phase, // (0.5 + (phase*0.5)), 
...
// inimigos fase 2
  ...
  static Enemy createGhost(Vector2 pos,{bool noChamp = false, int champType = 0, int phase = 1}) {
    return Enemy(
      ...
      noChamp: noChamp,
      championType: champType,
      hp: hpForte * phase, // (0.5 + (phase*0.5)),
      speed: 40,
      voa: true,
      hbSize: Vector2(14,14),
      hasGhostEffect: true,
  ...
  static Enemy createChessRook(Vector2 pos,{bool noChamp = false, int champType = 0, int phase = 1}) {
    return Enemy(
      ...
      noChamp: noChamp,
      championType: champType,
      hp: hpResistente * phase, // (0.5 + (phase*0.5)),
      speed: 0,
      hbSize: Vector2(8,14),
      weight: 100,
  ...
  static EnemyBoss createTruQueen(Vector2 pos, {int phase = 1}) {
    return EnemyBoss(
      ...
      hp: hpBossForte * phase, // (0.5 + (phase*0.5)), 
      position: Vector2(0, -100),
      speed: 60,
      soul: 300, 
  ...
  static Enemy createElephant(Vector2 pos,{bool noChamp = false, int champType = 0, int phase = 1}) {
    return Enemy(
      ...
      noChamp: noChamp,
      championType: champType,
      hp: hpTanque * phase, // (0.5 + (phase*0.5)),
      speed: 50,
